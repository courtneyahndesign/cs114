...
print("Are you ready to embark on a magical space dungeon adventure?")
answer = input()

print(str(answer) + "?!! Well regardless of what you said, we're already here. What's your name again?")
playername = input()
...
def fight(oppo1, oppo2):
    while (oppo1['HP'] > 0) and (oppo2['HP'] > 0):
        ...
        if oppo1['HP'] <= 0:
            ...
            game_over(oppo1)
    print(str(playername) + ' oppo1 HP: ', oppo1['HP'])
